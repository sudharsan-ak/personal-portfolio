  ...
  return (
    <section id="about" className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-muted/30">
      <div className="max-w-6xl mx-auto">
        ...
        {/* About Summary in a Card */}
        <Card className="p-8 mb-16 shadow-lg hover:shadow-2xl transition-all duration-300">
          <p
            className="text-base leading-relaxed text-foreground mb-4"
            data-testid="text-summary"
          >
            Full Stack Developer with 5+ years of experience in building scalable, interactive web
            applications using JavaScript, Node.js, and MongoDB.
          </p>
          <p className="text-base leading-relaxed text-foreground mb-4">
            Skilled in performance optimization and UI/UX improvements, with a strong record of
            collaboration in Agile teams. I’ve delivered high-quality, user-centric web solutions
            accessed by multiple clients and internal teams.
          </p>
          <p className="text-base leading-relaxed text-foreground">
            I specialize in modern web technologies and have a proven track record of reducing load
            times, improving data efficiency, and implementing secure, scalable systems.
          </p>
        </Card>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {education.map((edu, index) => (
              <Card
                key={index}
                className="p-6 shadow-lg hover:shadow-xl transition-transform transform hover:-translate-y-1 duration-300"
